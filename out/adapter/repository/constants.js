...
exports.LOG_FORMAT = exports.newLineFormatCode = exports.LOG_FORMAT_ARGS = exports.STATS_SEPARATOR = exports.ITEM_ENTRY_SEPARATOR = exports.LOG_ENTRY_SEPARATOR = void 0;
...
exports.LOG_FORMAT = `--format=${exports.LOG_ENTRY_SEPARATOR}${[
    ...exports.LOG_FORMAT_ARGS,
    exports.STATS_SEPARATOR,
    exports.ITEM_ENTRY_SEPARATOR,
].join(exports.ITEM_ENTRY_SEPARATOR)}`;
